...
// api_service_id = UnlockBase reseller service ID (fill from your reseller panel)
const SERVICE_CATALOGUE = [
  // ── Server / Tool Licences ──
  ['Adam Tool Credit For Xiaomi/OnePlus/Realme [Existing User]',    0.89,  0.62,  'Adam Tool',          'Instant',    'server', null],
  ['Ameer Tool (Hardware Tool) 1 PC - 3 Month [Digital License]',  32.99, 22.35,  'Ameer Tool',          'Instant',    'server', null],
  ['Ameer Tool (Hardware Tool) 1 PC - 6 Month [Digital License]',  44.99, 30.49,  'Ameer Tool',          'Instant',    'server', null],
  ['Android Multi Tool (AMT) Server Credits',                        1.49,  1.20,  'Android Multi Tool',  'Instant',    'server', null],
  ['Android Multi Tool - 3 Month Activation (AMT)',                 14.99, 10.20,  'Android Multi Tool',  'Instant',    'server', null],
  ['Xiaomi Anonymous Tool Credits for Existing User',                0.59,  0.38,  'Anonymous Xiaomi',    'Instant',    'server', null],
  ['Borneo Schematics Hardware Tool Activation [1 Year]',           49.99, 35.00,  'Borneo Schematics',   'Instant',    'server', null],
  ['Chimera Tool Basic (Instant API)',                              119.99, 85.00,  'Chimera Tool',        'Instant',    'server', null],
  ['Sigma Plus 1 Month Digital License',                            49.99, 39.00,  'Sigma Plus',          'Instant',    'server', null],
  ['DFT Pro Tool Activation [New User] 1 Year',                    119.99, 88.00,  'DFT Tool',            '1-12 Hours', 'server', null],
  ['UnlockTool 12 Months License [New / Renew]',                   189.99,149.99,  'Unlock Tool',         '1-12 Hours', 'server', null],
  ['Z3X Sam Tool Activation',                                       89.99, 69.00,  'Z3X Box',             'Instant',    'server', null],
  // ── IMEI Unlock ──
  ['iPhone Factory Unlock - T-Mobile USA (All Models)',             49.99, 27.00,  'iPhone Unlock',       '1-3 Days',   'imei',   null],
  ['iPhone Factory Unlock - AT&T USA (All Models)',                 39.99,  5.00,  'iPhone Unlock',       '1-5 Days',   'imei',   null],
  ['iPhone Factory Unlock - Verizon USA (All Models)',              54.99, 18.00,  'iPhone Unlock',       '2-7 Days',   'imei',   null],
  ['Samsung Factory Unlock - T-Mobile USA (All Models)',            29.99, 12.00,  'Samsung Unlock',      '1-24 Hours', 'imei',   null],
  ['Samsung Factory Unlock - AT&T USA (All Models)',                59.99, 39.95,  'Samsung Unlock',      '1-24 Hours', 'imei',   null],
  ['Motorola Network Unlock - All USA Carriers',                    19.99,  5.00,  'Motorola Unlock',     'Instant',    'imei',   null],
  ['LG Factory Unlock - Premium Service (All Models)',              24.99,  8.00,  'LG Unlock',           '1-12 Hours', 'imei',   null],
  ['Google Pixel Unlock - All Carriers (All Models)',               29.99, 10.00,  'Google Unlock',       'Instant',    'imei',   null],
  ['Huawei Factory Unlock - All Models & Carriers',                 39.99, 15.00,  'Huawei Unlock',       '1-3 Days',   'imei',   null],
  ['OnePlus Network Unlock - All Carriers',                         19.99,  7.00,  'OnePlus Unlock',      'Instant',    'imei',   null],
  ['Xiaomi / Redmi Factory Unlock Service',                         24.99,  9.00,  'Xiaomi Unlock',       '1-24 Hours', 'imei',   null],
  // ── FRP Remove by IMEI ──
  // ── Samsung FRP — Series A (Mid-Range) ──
  ['Samsung Series A FRP Remove - Android 16/17 (A14/A25/A35/A55)',          19.99,  9.50,  'FRP By IMEI',  '1-6 Hours',  'imei',   null],
  ['Samsung Series A FRP Remove - Android 16/17 Latest Binary/Bit',          22.99, 11.00,  'FRP By IMEI',  '1-6 Hours',  'imei',   null],
  ['Samsung Series A FRP Remove - Android 11/12/13/14 (A12/A13/A32/A52)',    14.99,  7.00,  'FRP By IMEI',  '1-6 Hours',  'imei',   null],
  ['Samsung Series A FRP Remove - Android 9/10 (A10/A20/A30/A50)',           11.99,  5.00,  'FRP By IMEI',  '1-6 Hours',  'imei',   null],
  // ── Samsung FRP — Series S (Flagship) ──
  ['Samsung Series S FRP Remove - Android 16/17 (S24/S25/Ultra)',             29.99, 15.00,  'FRP By IMEI',  '1-6 Hours',  'imei',   null],
  ['Samsung Series S FRP Remove - Android 16/17 Latest Binary/Bit',          34.99, 18.00,  'FRP By IMEI',  '1-6 Hours',  'imei',   null],
  ['Samsung Series S FRP Remove - Android 11/12/13/14 (S21/S22/S23)',        24.99, 12.00,  'FRP By IMEI',  '1-6 Hours',  'imei',   null],
  ['Samsung Series S FRP Remove - Android 9/10 (S10/S20)',                   19.99,  9.00,  'FRP By IMEI',  '1-6 Hours',  'imei',   null],
  ['Google Pixel FRP / Google Account Remove By IMEI',              19.99,  9.00,  'FRP By IMEI',         '1-12 Hours', 'imei',   null],
  ['Xiaomi / Redmi FRP & Mi Account Remove By IMEI',                14.99,  6.50,  'FRP By IMEI',         '1-12 Hours', 'imei',   null],
  ['Huawei FRP / Google Account Remove By IMEI',                    14.99,  6.00,  'FRP By IMEI',         '1-6 Hours',  'imei',   null],
  ['Oppo / Realme FRP Remove By IMEI (All Models)',                  12.99,  5.00,  'FRP By IMEI',         '1-24 Hours', 'imei',   null],
  ['Tecno / Infinix / iTel FRP Remove By IMEI',                     11.99,  4.50,  'FRP By IMEI',         '1-24 Hours', 'imei',   null],
  ['Motorola FRP / Google Account Remove By IMEI',                  12.99,  5.00,  'FRP By IMEI',         '1-12 Hours', 'imei',   null],
  ['LG FRP / Google Account Remove By IMEI',                        12.99,  5.00,  'FRP By IMEI',         '1-12 Hours', 'imei',   null],
  ['OnePlus FRP / Google Account Remove By IMEI',                   12.99,  5.00,  'FRP By IMEI',         '1-12 Hours', 'imei',   null],
  ['Universal Android FRP Remove By IMEI (Any Brand)',              17.99,  8.00,  'FRP By IMEI',         '1-24 Hours', 'imei',   null],
  // ── Remote Services ──
  ['Xiaomi Mi Account Remove - Permanent',                          24.99, 13.50,  'Xiaomi Mi Account',   '1-12 Hours', 'remote', null],
  ['Tecno / Infinix / iTel MDM Remove Permanent',                   18.99,  9.00,  'Tecno MDM',           '1-24 Hours', 'remote', null],
  ['Samsung MDM Remove - Knox Bypass Service',                      94.99, 67.00,  'Samsung MDM',         '1-12 Hours', 'remote', null],
  ['iPhone iCloud Activation Lock Remove',                          99.99, 65.00,  'iCloud Unlock',       '2-7 Days',   'remote', null],
  ['Android Screen Lock Remove (PIN / Pattern / Password)',          14.99,  5.00,  'Screen Unlock',       '1-3 Hours',  'remote', null],
  // ── File Services ──
  ['Samsung Flash File - U/U1 Binary (Latest Official)',             9.99,  4.00,  'Samsung Firmware',    'Instant',    'file',   null],
  ['Xiaomi Firmware Flash File - Latest MIUI',                       7.99,  3.00,  'Xiaomi Firmware',     'Instant',    'file',   null],
  ['Huawei Stock ROM / Firmware Package',                            8.99,  3.50,  'Huawei Firmware',     'Instant',    'file',   null],
