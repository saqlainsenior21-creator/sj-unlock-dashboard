...
// Profit margins: Server tools ~30-40%, IMEI unlock ~70-85%, FRP ~70-80%
const SERVICE_CATALOGUE = [
  // ── Server / Tool Licences ──
  ['Adam Tool Credit For Xiaomi/OnePlus/Realme [Existing User]',    0.79,  0.48,  'Adam Tool',          'Instant',    'server', null],
  ['Ameer Tool (Hardware Tool) 1 PC - 3 Month [Digital License]',  28.99, 18.50,  'Ameer Tool',          'Instant',    'server', null],
  ['Ameer Tool (Hardware Tool) 1 PC - 6 Month [Digital License]',  39.99, 26.00,  'Ameer Tool',          'Instant',    'server', null],
  ['Android Multi Tool (AMT) Server Credits',                        1.29,  0.90,  'Android Multi Tool',  'Instant',    'server', null],
  ['Android Multi Tool - 3 Month Activation (AMT)',                 12.99,  8.50,  'Android Multi Tool',  'Instant',    'server', null],
  ['Xiaomi Anonymous Tool Credits for Existing User',                0.49,  0.28,  'Anonymous Xiaomi',    'Instant',    'server', null],
  ['Borneo Schematics Hardware Tool Activation [1 Year]',           44.99, 30.00,  'Borneo Schematics',   'Instant',    'server', null],
  ['Chimera Tool Basic (Instant API)',                              109.99, 78.00,  'Chimera Tool',        'Instant',    'server', null],
  ['Sigma Plus 1 Month Digital License',                            44.99, 34.00,  'Sigma Plus',          'Instant',    'server', null],
  ['DFT Pro Tool Activation [New User] 1 Year',                    109.99, 80.00,  'DFT Tool',            '1-12 Hours', 'server', null],
  ['UnlockTool 12 Months License [New / Renew]',                   169.99,135.00,  'Unlock Tool',         '1-12 Hours', 'server', null],
  ['Z3X Sam Tool Activation',                                       79.99, 60.00,  'Z3X Box',             'Instant',    'server', null],
  // ── IMEI Unlock — costs based on GsmServer wholesale (May 2026) ──
  ['iPhone Factory Unlock - T-Mobile USA (All Models)',             22.99,  5.50,  'iPhone Unlock',       '1-3 Days',   'imei',   null],
  ['iPhone Factory Unlock - AT&T USA (All Models)',                 17.99,  4.00,  'iPhone Unlock',       '1-5 Days',   'imei',   null],
  ['iPhone Factory Unlock - Verizon USA (All Models)',              39.99, 12.00,  'iPhone Unlock',       '2-7 Days',   'imei',   null],
  ['iPhone Factory Unlock - Sprint / Metro USA (All Models)',       17.99,  3.50,  'iPhone Unlock',       '1-3 Days',   'imei',   null],
  ['Samsung Factory Unlock - T-Mobile USA (All Models)',            12.99,  2.50,  'Samsung Unlock',      '1-24 Hours', 'imei',   null],
  ['Samsung Factory Unlock - AT&T USA (All Models)',                24.99,  8.50,  'Samsung Unlock',      '1-24 Hours', 'imei',   null],
  ['Motorola Network Unlock - All USA Carriers',                    11.99,  1.50,  'Motorola Unlock',     'Instant',    'imei',   null],
  ['LG Factory Unlock - Premium Service (All Models)',              13.99,  2.50,  'LG Unlock',           '1-12 Hours', 'imei',   null],
  ['Google Pixel Unlock - All Carriers (All Models)',               17.99,  4.50,  'Google Unlock',       'Instant',    'imei',   null],
  ['Huawei Factory Unlock - All Models & Carriers',                 22.99,  6.50,  'Huawei Unlock',       '1-3 Days',   'imei',   null],
  ['OnePlus Network Unlock - All Carriers',                         11.99,  2.00,  'OnePlus Unlock',      'Instant',    'imei',   null],
  ['Xiaomi / Redmi Factory Unlock Service',                         13.99,  3.00,  'Xiaomi Unlock',       '1-24 Hours', 'imei',   null],
  // ── FRP Remove by IMEI — GsmServer wholesale costs ──
  // ── Samsung FRP — Series A (Mid-Range) ──
  ['Samsung Series A FRP Remove - Android 16/17 (A14/A25/A35/A55)',          13.99,  4.50,  'FRP By IMEI',  '1-6 Hours',  'imei',   null],
  ['Samsung Series A FRP Remove - Android 16/17 Latest Binary/Bit',          16.99,  6.00,  'FRP By IMEI',  '1-6 Hours',  'imei',   null],
  ['Samsung Series A FRP Remove - Android 11/12/13/14 (A12/A13/A32/A52)',    10.99,  3.00,  'FRP By IMEI',  '1-6 Hours',  'imei',   null],
  ['Samsung Series A FRP Remove - Android 9/10 (A10/A20/A30/A50)',            7.99,  1.80,  'FRP By IMEI',  '1-6 Hours',  'imei',   null],
  // ── Samsung FRP — Series S (Flagship) ──
  ['Samsung Series S FRP Remove - Android 16/17 (S24/S25/Ultra)',             20.99,  8.00,  'FRP By IMEI',  '1-6 Hours',  'imei',   null],
  ['Samsung Series S FRP Remove - Android 16/17 Latest Binary/Bit',          24.99, 10.00,  'FRP By IMEI',  '1-6 Hours',  'imei',   null],
  ['Samsung Series S FRP Remove - Android 11/12/13/14 (S21/S22/S23)',        16.99,  5.50,  'FRP By IMEI',  '1-6 Hours',  'imei',   null],
  ['Samsung Series S FRP Remove - Android 9/10 (S10/S20)',                   12.99,  3.50,  'FRP By IMEI',  '1-6 Hours',  'imei',   null],
  ['Google Pixel FRP / Google Account Remove By IMEI',              12.99,  4.50,  'FRP By IMEI',         '1-12 Hours', 'imei',   null],
  ['Xiaomi / Redmi FRP & Mi Account Remove By IMEI',                 8.99,  2.80,  'FRP By IMEI',         '1-12 Hours', 'imei',   null],
  ['Huawei FRP / Google Account Remove By IMEI',                     8.99,  2.50,  'FRP By IMEI',         '1-6 Hours',  'imei',   null],
  ['Oppo / Realme FRP Remove By IMEI (All Models)',                   6.99,  2.00,  'FRP By IMEI',         '1-24 Hours', 'imei',   null],
  ['Tecno / Infinix / iTel FRP Remove By IMEI',                      6.99,  1.80,  'FRP By IMEI',         '1-24 Hours', 'imei',   null],
  ['Motorola FRP / Google Account Remove By IMEI',                    7.99,  2.00,  'FRP By IMEI',         '1-12 Hours', 'imei',   null],
  ['LG FRP / Google Account Remove By IMEI',                          7.99,  2.00,  'FRP By IMEI',         '1-12 Hours', 'imei',   null],
  ['OnePlus FRP / Google Account Remove By IMEI',                     7.99,  2.00,  'FRP By IMEI',         '1-12 Hours', 'imei',   null],
  ['Universal Android FRP Remove By IMEI (Any Brand)',               11.99,  3.50,  'FRP By IMEI',         '1-24 Hours', 'imei',   null],
  // ── Remote Services ──
  ...
  ['Xiaomi Firmware Flash File - Latest MIUI',                        5.99,  1.80,  'Xiaomi Firmware',     'Instant',    'file',   null],
  ['Huawei Stock ROM / Firmware Package',                             6.99,  2.20,  'Huawei Firmware',     'Instant',    'file',   null],
  ['Tecno / Infinix Stock Firmware Package',                          4.99,  1.50,  'Tecno Firmware',      'Instant',    'file',   null],
  ['Samsung ENG Boot File (Root / EFS Backup)',                      11.99,  4.00,  'Samsung ENG',         'Instant',    'file',   null],
  ['MTK CPU Auth / DA File Service',                                  7.99,  2.50,  'MTK Auth File',       'Instant',    'file',   null],
